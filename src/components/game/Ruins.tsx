  ...
  return (
    <group position={position} rotation={rotation}>
      <mesh position={[0, 0.65, 0]} castShadow>
        ...
        <meshStandardMaterial color="#343c45" roughness={0.92} flatShading />
      </mesh>
      <mesh position={[0, 1.35, 0]} castShadow>
        <boxGeometry args={[0.7, 0.18, 0.7]} />
        <meshStandardMaterial color="#526170" roughness={0.9} flatShading />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group name="forgotten-shore-ruins">
      ...
      <mesh position={[0, -0.72, -5.5]} rotation={[0.02, 0.08, 0.02]} castShadow>
        ...
        <meshStandardMaterial color="#343c45" roughness={0.98} flatShading />
      </mesh>
      <mesh position={[-1.6, -0.55, -5.45]} rotation={[0.02, 0.08, -0.04]}>
        <boxGeometry args={[0.36, 1.15, 0.42]} />
        <meshStandardMaterial color="#414e5c" roughness={0.95} flatShading />
      </mesh>
