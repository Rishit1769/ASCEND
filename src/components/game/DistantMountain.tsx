  ...
  return (
    <group position={[0, -1.05, -11]}>
      <mesh position={[-3.8, 2.2, 0]} scale={[1.5, 1.5, 1.2]}>
        ...
        <meshStandardMaterial color="#1D2838" roughness={1} flatShading />
      </mesh>
      <mesh position={[0, 2.8, -0.5]} scale={[1.8, 1.8, 1.4]}>
        <coneGeometry args={[2.8, 7.5, 6]} />
        <meshStandardMaterial color="#263448" roughness={1} flatShading />
      </mesh>
      <mesh position={[4.2, 1.9, 0.3]} scale={[1.4, 1.4, 1.1]}>
        <coneGeometry args={[2.5, 5.8, 5]} />
        <meshStandardMaterial color="#151E2A" roughness={1} flatShading />
      </mesh>

      <group position={[0, 1.4, 1.4]}>
        <mesh position={[0, 0.9, 0]}>
          <boxGeometry args={[2.4, 1.7, 0.6]} />
          <meshStandardMaterial color="#1B2635" roughness={1} />
        </mesh>
        <mesh position={[-0.8, 1.9, 0]}>
          <coneGeometry args={[0.45, 1.4, 4]} />
          <meshStandardMaterial color="#202D3D" roughness={1} />
        </mesh>
        <mesh position={[0.8, 1.9, 0]}>
          <coneGeometry args={[0.45, 1.4, 4]} />
          <meshStandardMaterial color="#1B2635" roughness={1} />
        ...
        <pointLight position={[0, 1.65, 0.15]} color="#D9A441" intensity={0.32} distance={4} decay={2} />
        <pointLight position={[0, 1.65, 0.1]} color="#8B7CFF" intensity={0.12} distance={3} decay={2} />
